...
// remove percent sign, eg. '100%' => '100'
type GetValueWithoutSign<T extends string> = T extends `${infer R}%` ? R : T;

// remove sign, eg. '+100%' => '100%'
type GetValue<T extends string> = T extends `${'-' | '+'}${infer R}` ? GetValueWithoutSign<R> : GetValueWithoutSign<T>
